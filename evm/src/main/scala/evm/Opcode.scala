...
object Opcode:
  ...
  def decode(b: Int): Option[Opcode] = b match
    case 0x00 => Some(Opcode.STOP)
    case 0x01 => Some(Opcode.ADD)
    case 0x02 => Some(Opcode.MUL)
    case 0x03 => Some(Opcode.SUB)
    case 0x04 => Some(Opcode.DIV)
    case 0x05 => Some(Opcode.SDIV)
    case 0x06 => Some(Opcode.MOD)
    case 0x07 => Some(Opcode.SMOD)
    case 0x08 => Some(Opcode.ADDMOD)
    case 0x09 => Some(Opcode.MULMOD)
    case 0x0A => Some(Opcode.EXP)
    case 0x0B => Some(Opcode.SIGNEXTEND)
    case 0x10 => Some(Opcode.LT)
    case 0x11 => Some(Opcode.GT)
    case 0x12 => Some(Opcode.SLT)
    case 0x13 => Some(Opcode.SGT)
    case 0x14 => Some(Opcode.EQ)
    case 0x15 => Some(Opcode.ISZERO)
    case 0x16 => Some(Opcode.AND)
    case 0x17 => Some(Opcode.OR)
    case 0x18 => Some(Opcode.XOR)
    case 0x19 => Some(Opcode.NOT)
    case 0x1A => Some(Opcode.BYTE)
    case 0x1B => Some(Opcode.SHL)
    case 0x1C => Some(Opcode.SHR)
    case 0x1D => Some(Opcode.SAR)
    case 0x1E => Some(Opcode.CLZ)
    case 0x20 => Some(Opcode.KECCAK256)
    case 0x30 => Some(Opcode.ADDRESS)
    case 0x31 => Some(Opcode.BALANCE)
    case 0x32 => Some(Opcode.ORIGIN)
    case 0x33 => Some(Opcode.CALLER)
    case 0x34 => Some(Opcode.CALLVALUE)
    case 0x35 => Some(Opcode.CALLDATALOAD)
    case 0x36 => Some(Opcode.CALLDATASIZE)
    case 0x37 => Some(Opcode.CALLDATACOPY)
    case 0x38 => Some(Opcode.CODESIZE)
    case 0x39 => Some(Opcode.CODECOPY)
    case 0x3A => Some(Opcode.GASPRICE)
    case 0x3B => Some(Opcode.EXTCODESIZE)
    case 0x3C => Some(Opcode.EXTCODECOPY)
    case 0x3D => Some(Opcode.RETURNDATASIZE)
    case 0x3E => Some(Opcode.RETURNDATACOPY)
    case 0x3F => Some(Opcode.EXTCODEHASH)
    case 0x40 => Some(Opcode.BLOCKHASH)
    case 0x41 => Some(Opcode.COINBASE)
    case 0x42 => Some(Opcode.TIMESTAMP)
    case 0x43 => Some(Opcode.NUMBER)
    case 0x44 => Some(Opcode.PREVRANDAO)
    case 0x45 => Some(Opcode.GASLIMIT)
    case 0x46 => Some(Opcode.CHAINID)
    case 0x47 => Some(Opcode.SELFBALANCE)
    case 0x48 => Some(Opcode.BASEFEE)
    case 0x49 => Some(Opcode.BLOBHASH)
    case 0x4A => Some(Opcode.BLOBBASEFEE)
    case 0x50 => Some(Opcode.POP)
    case 0x51 => Some(Opcode.MLOAD)
    case 0x52 => Some(Opcode.MSTORE)
    case 0x53 => Some(Opcode.MSTORE8)
    case 0x54 => Some(Opcode.SLOAD)
    case 0x55 => Some(Opcode.SSTORE)
    case 0x56 => Some(Opcode.JUMP)
    case 0x57 => Some(Opcode.JUMPI)
    case 0x58 => Some(Opcode.PC)
    case 0x59 => Some(Opcode.MSIZE)
    case 0x5A => Some(Opcode.GAS)
    case 0x5B => Some(Opcode.JUMPDEST)
    case 0x5C => Some(Opcode.TLOAD)
    case 0x5D => Some(Opcode.TSTORE)
    case 0x5E => Some(Opcode.MCOPY)
    case 0x5F => Some(Opcode.PUSH0)
    case 0x60 => Some(Opcode.PUSH1)
    case 0x61 => Some(Opcode.PUSH2)
    case 0x62 => Some(Opcode.PUSH3)
    case 0x63 => Some(Opcode.PUSH4)
    case 0x64 => Some(Opcode.PUSH5)
    case 0x65 => Some(Opcode.PUSH6)
    case 0x66 => Some(Opcode.PUSH7)
    case 0x67 => Some(Opcode.PUSH8)
    case 0x68 => Some(Opcode.PUSH9)
    case 0x69 => Some(Opcode.PUSH10)
    case 0x6A => Some(Opcode.PUSH11)
    case 0x6B => Some(Opcode.PUSH12)
    case 0x6C => Some(Opcode.PUSH13)
    case 0x6D => Some(Opcode.PUSH14)
    case 0x6E => Some(Opcode.PUSH15)
    case 0x6F => Some(Opcode.PUSH16)
    case 0x70 => Some(Opcode.PUSH17)
    case 0x71 => Some(Opcode.PUSH18)
    case 0x72 => Some(Opcode.PUSH19)
    case 0x73 => Some(Opcode.PUSH20)
    case 0x74 => Some(Opcode.PUSH21)
    case 0x75 => Some(Opcode.PUSH22)
    case 0x76 => Some(Opcode.PUSH23)
    case 0x77 => Some(Opcode.PUSH24)
    case 0x78 => Some(Opcode.PUSH25)
    case 0x79 => Some(Opcode.PUSH26)
    case 0x7A => Some(Opcode.PUSH27)
    case 0x7B => Some(Opcode.PUSH28)
    case 0x7C => Some(Opcode.PUSH29)
    case 0x7D => Some(Opcode.PUSH30)
    case 0x7E => Some(Opcode.PUSH31)
    case 0x7F => Some(Opcode.PUSH32)
    case 0x80 => Some(Opcode.DUP1)
    case 0x81 => Some(Opcode.DUP2)
    case 0x82 => Some(Opcode.DUP3)
    case 0x83 => Some(Opcode.DUP4)
    case 0x84 => Some(Opcode.DUP5)
    case 0x85 => Some(Opcode.DUP6)
    case 0x86 => Some(Opcode.DUP7)
    case 0x87 => Some(Opcode.DUP8)
    case 0x88 => Some(Opcode.DUP9)
    case 0x89 => Some(Opcode.DUP10)
    case 0x8A => Some(Opcode.DUP11)
    case 0x8B => Some(Opcode.DUP12)
    case 0x8C => Some(Opcode.DUP13)
    case 0x8D => Some(Opcode.DUP14)
    case 0x8E => Some(Opcode.DUP15)
    case 0x8F => Some(Opcode.DUP16)
    case 0x90 => Some(Opcode.SWAP1)
    case 0x91 => Some(Opcode.SWAP2)
    case 0x92 => Some(Opcode.SWAP3)
    case 0x93 => Some(Opcode.SWAP4)
    case 0x94 => Some(Opcode.SWAP5)
    case 0x95 => Some(Opcode.SWAP6)
    case 0x96 => Some(Opcode.SWAP7)
    case 0x97 => Some(Opcode.SWAP8)
    case 0x98 => Some(Opcode.SWAP9)
    case 0x99 => Some(Opcode.SWAP10)
    case 0x9A => Some(Opcode.SWAP11)
    case 0x9B => Some(Opcode.SWAP12)
    case 0x9C => Some(Opcode.SWAP13)
    case 0x9D => Some(Opcode.SWAP14)
    case 0x9E => Some(Opcode.SWAP15)
    case 0x9F => Some(Opcode.SWAP16)
    case 0xA0 => Some(Opcode.LOG0)
    case 0xA1 => Some(Opcode.LOG1)
    case 0xA2 => Some(Opcode.LOG2)
    case 0xA3 => Some(Opcode.LOG3)
    case 0xA4 => Some(Opcode.LOG4)
    case 0xF0 => Some(Opcode.CREATE)
    case 0xF1 => Some(Opcode.CALL)
    case 0xF2 => Some(Opcode.CALLCODE)
    case 0xF3 => Some(Opcode.RETURN)
    case 0xF4 => Some(Opcode.DELEGATECALL)
    case 0xF5 => Some(Opcode.CREATE2)
    case 0xFA => Some(Opcode.STATICCALL)
    case 0xFD => Some(Opcode.REVERT)
    case 0xFE => Some(Opcode.INVALID)
    case 0xFF => Some(Opcode.SELFDESTRUCT)
    case _ => None()
